...
import { push, swap } from '../runtime/stack';
import { get_printname, push_symbol } from '../runtime/symbol';
import { compare_numbers, push_integer } from './bignum';
