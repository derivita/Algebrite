...
export function Eval_approxratio(p1: U) {
  const theArgument = cadr(p1);
  push(theArgument);
  approxratioRecursive();
}

function approxratioRecursive() {
  const expr = pop();
  if (istensor(expr)) {
    const p4 = alloc_tensor(expr.tensor.nelem);
    p4.tensor.ndim = expr.tensor.ndim;
    for (let i = 0; i < expr.tensor.ndim; i++) {
      p4.tensor.dim[i] = expr.tensor.dim[i];
    }
    for (let i = 0; i < expr.tensor.nelem; i++) {
...
function approxOneRatioOnly() {
  zzfloat();
  const supposedlyTheFloat = pop();
...
function floatToRatioRoutine(decimal, AccuracyFactor) {
  ...
  let FractionDenominator = undefined;
  let DecimalSign = undefined;
  let Z = undefined;
  let PreviousDenominator = undefined;
  let ScratchValue = undefined;
  const ret = [0, 0];
  if (isNaN(decimal)) {
    return ret;
  }
...
export function approxAll(theFloat: number): ApproxResult {
  ...
  if (approxRadicalsResult != null) {
    ...
    if (constantsSum < constantsSumMin) {
      if (LOG_EXPLANATIONS) {
        console.log(
          'better explanation by approxRadicals: ' +
            approxRadicalsResult +
            ' complexity: ' +
            constantsSum
        );
      }
      ...
      if (LOG_EXPLANATIONS) {
        console.log(
          'subpar explanation by approxRadicals: ' +
            approxRadicalsResult +
            ' complexity: ' +
            constantsSum
        );
  ...
  if (approxLogsResult != null) {
    ...
    if (constantsSum < constantsSumMin) {
      if (LOG_EXPLANATIONS) {
        console.log(
          'better explanation by approxLogs: ' +
            approxLogsResult +
            ' complexity: ' +
            constantsSum
        );
      ...
      if (LOG_EXPLANATIONS) {
        console.log(
          'subpar explanation by approxLogs: ' +
            approxLogsResult +
            ' complexity: ' +
            constantsSum
        );
  ...
  if (approxRationalsOfPowersOfEResult != null) {
    ...
    if (constantsSum < constantsSumMin) {
      if (LOG_EXPLANATIONS) {
        console.log(
          'better explanation by approxRationalsOfPowersOfE: ' +
      ...
      if (LOG_EXPLANATIONS) {
        console.log(
          'subpar explanation by approxRationalsOfPowersOfE: ' +
            approxRationalsOfPowersOfEResult +
            ' complexity: ' +
            constantsSum
        );
  ...
  if (approxRationalsOfPowersOfPIResult != null) {
    ...
    if (constantsSum < constantsSumMin) {
      if (LOG_EXPLANATIONS) {
        console.log(
          'better explanation by approxRationalsOfPowersOfPI: ' +
      ...
      if (LOG_EXPLANATIONS) {
        console.log(
          'subpar explanation by approxRationalsOfPowersOfPI: ' +
            approxRationalsOfPowersOfPIResult +
            ' complexity: ' +
            constantsSum
        );
  ...
  if (approxTrigonometricResult != null) {
    ...
    if (constantsSum < constantsSumMin) {
      if (LOG_EXPLANATIONS) {
        console.log(
          'better explanation by approxTrigonometric: ' +
      ...
      if (LOG_EXPLANATIONS) {
        console.log(
          'subpar explanation by approxTrigonometric: ' +
            approxTrigonometricResult +
            ' complexity: ' +
            constantsSum
        );
...
export function testApprox() {
  for (let i of [2, 3, 5, 6, 7, 8, 10]) {
    for (let j of [2, 3, 5, 6, 7, 8, 10]) {
      ...
      if (Math.abs(value - returnedValue) > 1e-15) {
        console.log(
          'fail testapproxRadicals: 1 * sqrt( ' +
            i +
            ' ) / ' +
            j +
            ' . obtained: ' +
  ...
  for (let i of [2, 3, 5, 6, 7, 8, 10]) {
    for (let j of [2, 3, 5, 6, 7, 8, 10]) {
      ...
      if (Math.abs(originalValue - returnedValue) > 1e-15) {
        console.log(
          'fail testapproxRadicals with 4 digits: 1 * sqrt( ' +
            i +
            ' ) / ' +
            j +
            ' . obtained: ' +
  ...
  for (let i of [2, 3, 5, 6, 7, 8, 10]) {
    for (let j of [2, 3, 5, 6, 7, 8, 10]) {
      ...
      console.log(
        'testapproxRadicals testing: 1 * sqrt( ' + i + ' / ' + j + ' )'
      );
      const fraction = i / j;
      const value = Math.sqrt(i / j);
      const returned = approxRadicals(value);
  ...
  for (let i of [1, 2, 3, 5, 6, 7, 8, 10]) {
    for (let j of [1, 2, 3, 5, 6, 7, 8, 10]) {
      ...
      console.log(
        'testapproxRadicals testing with 4 digits:: 1 * sqrt( ' +
          i +
          ' / ' +
          j +
          ' )'
  ...
  for (let i = 1; i <= 5; i++) {
    for (let j = 1; j <= 5; j++) {
      console.log(
        'testApproxAll testing with 4 digits: 1 * log(' + i + ' ) / ' + j
      );
      const fraction = i / j;
      ...
      if (Math.abs(originalValue - returnedValue) > 1e-15) {
        console.log(
          'fail testApproxAll with 4 digits: 1 * log(' +
            i +
            ' ) / ' +
            j +
            ' . obtained: ' +
  ...
  for (let i = 1; i <= 2; i++) {
    for (let j = 1; j <= 12; j++) {
      console.log(
        'approxRationalsOfPowersOfE testing with 4 digits: 1 * (e ^ ' +
          i +
          ' ) / ' +
          j
      );
      ...
      if (Math.abs(originalValue - returnedValue) > 1e-15) {
        console.log(
          'fail approxRationalsOfPowersOfE with 4 digits: 1 * (e ^ ' +
            i +
            ' ) / ' +
            j +
            ' . obtained: ' +
  ...
  for (let i = 1; i <= 2; i++) {
    for (let j = 1; j <= 12; j++) {
      console.log(
        'approxRationalsOfPowersOfPI testing with 4 digits: 1 * pi ^ ' +
          i +
          ' / ' +
          j
      );
      ...
      if (Math.abs(originalValue - returnedValue) > 1e-15) {
        console.log(
          'fail approxRationalsOfPowersOfPI with 4 digits: 1 * pi ^ ' +
            i +
            ' / ' +
            j +
            ' ) . obtained: ' +
  ...
  for (let i = 1; i <= 4; i++) {
    for (let j = 1; j <= 4; j++) {
      console.log(
        'testApproxAll testing with 5 digits: 1 * sin( ' + i + '/' + j + ' )'
      );
      const fraction = i / j;
      ...
      if (returned == null) {
        console.log(
          'fail testApproxAll with 5 digits: 1 * sin( ' +
            i +
            '/' +
            j +
            ' ) . obtained:  undefined '
  ...
  for (let i = 1; i <= 4; i++) {
    for (let j = 1; j <= 4; j++) {
      console.log(
        'testApproxAll testing with 4 digits: 1 * sin( ' + i + '/' + j + ' )'
      );
      const fraction = i / j;
      const originalValue = Math.sin(fraction);
      const value = originalValue.toFixed(4);
      ...
      if (returned == null) {
        console.log(
          'fail testApproxAll with 4 digits: 1 * sin( ' +
            i +
            '/' +
            j +
            ' ) . obtained:  undefined '
  ...
  for (let i = 1; i <= 13; i++) {
    for (let j = 1; j <= 13; j++) {
      console.log(
        'approxTrigonometric testing: 1 * sin( ' + i + '/' + j + ' * pi )'
      );
      const fraction = i / j;
      ...
      if (Math.abs(value - returnedValue) > 1e-15) {
        console.log(
          'fail approxTrigonometric: 1 * sin( ' +
            i +
            '/' +
            j +
            ' * pi ) . obtained: ' +
  ...
  for (let i = 1; i <= 13; i++) {
    for (let j = 1; j <= 13; j++) {
      ...
      console.log(
        'approxTrigonometric testing with 4 digits: 1 * sin( ' +
          i +
          '/' +
          j +
          ' * pi )'
      ...
      if (error > 1e-14) {
        console.log(
          'fail approxTrigonometric with 4 digits: 1 * sin( ' +
            i +
            '/' +
            j +
            ' * pi ) . obtained: ' +
